...
HT.Hexagon.prototype.draw = function(ctx) {
	this.drawBorder(ctx, "black");
	this.drawLabel(ctx, "black");
...
HT.Hexagon.prototype.drawBorder = function(ctx, color)
{
...
HT.Hexagon.prototype.drawLabel = function(ctx, color)
{
	if(this.Id)
	{
...
HT.Hexagon.prototype.drawStats = function(ctx)
{
